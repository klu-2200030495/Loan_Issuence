        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-xl p-8" data-aos="fade-up">
            <form method="post" action="checkadminlogin">
                <div class="grid gap-6">
                    <!-- Username Field -->
                    <div>
                        <label class="block text-gray-700 mb-2">Enter Username</label>
                        <input type="text" id="auname" name="auname" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary" required />
                    </div>

                    <!-- Password Field -->
                    <div>
                        <label class="block text-gray-700 mb-2">Enter Password</label>
                        <input type="password" id="apwd" name="apwd" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary" required />
                    </div>
                    ...
                    <div class="message mt-4 text-center">
